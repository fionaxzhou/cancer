...
if __name__=='__main__':
	...
	#call backs
        ...
        model.compile(
                ...
                loss=utils.dice_coef_loss_gen(smooth=cfg.smooth, pred_mul=cfg.pred_loss_mul, p_ave=cfg.p_ave)
                );
	...
	#Fit here
        history = model.fit_generator(train_data_aug, 
                ...
                nb_epoch=cfg.fitter['num_epochs'],
                validation_data = val_data, 
                nb_val_samples = len(full_train_data)//cfg.fitter['NCV'],
                #callbacks = [learn_rate_decay, model_checkpoint, earlystop, tensorboard]
